...
if page == "Introduction":
    ...
    """)
    st.image("/mount/src/scan/app/web_1.png")
...
##################
    ...
    solvent_properties = {
        ...
        'MC': [0.24685089, 0.37103257, 0, 0, 0, 0, 0, 0.16393443, 0.2453035, 0.15, 0, 0, 0.16666667,
                               0.16403677],
        ...
        'Cumene': [0.34933705, 0.73345166, 0, 0.08333333, 1, 0, 0, 0.39344262, 0.3198025, 0.45, 0, 0, 0.41189327,
                   0.499289],
        'PropSul': [0.43666913, 0.31875131, 0.73976165, 0.33333333, 0, 0, 0, 0.45901639, 0.40273299, 0.45, 0, 0.4,
                          0.45118446, 0.47803819],
        'Pseudo': [0.34933705, 0.68173418, 0, 0, 1, 0, 0, 0.39344262, 0.3198025, 0.45, 0, 0, 0.421937,
                         0.48697614],
    ...
    model = load_model(create_model(), path="/mount/src/scan/app/1_model.pth")
