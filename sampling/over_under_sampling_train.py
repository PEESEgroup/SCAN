...
def train_model(train_data, train_labels, val_data, val_labels, epochs=10, type=False):
    ...
    train_data_balanced, train_labels_balanced = smoter_focus_high_y(train_data_balanced, train_labels_balanced, k_neighbors=5, n_samples=your number, y_threshold=your cutoff)
